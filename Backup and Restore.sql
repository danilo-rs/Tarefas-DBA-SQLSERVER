...
BACKUP DATABASE CLIENTES
 TO DISK = 'P:\BACKUP\CLIENTES_1_FULL.BAK'
   WITH STATS
...
FROM  DISK = 'P:\BACKUP\CLIENTES_1_FULL.BAK'
...
BACKUP DATABASE CLIENTES
 TO DISK = 'P:\BACKUP\CLIENTES_3_FULL.BAK'
...
BACKUP LOG CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-LOG1.TRN'
...
---- Criando Backup com Arquivos de Log
BACKUP LOG CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-LOG2.TRN'
...
USE MASTER
GO
RESTORE DATABASE CLIENTES FROM DISK='P:\BACKUP\CLIENTES_1_FULL.BAK' 
WITH  NORECOVERY,STATS

--Restauracao 1º LOTE DE LOG
USE MASTER
GO
RESTORE LOG CLIENTES FROM DISK='P:\BACKUP\CLIENTES_BK-LOG1.TRN' 
WITH NORECOVERY, STATS

--Restauracao 2º LOTE DE LOG
USE MASTER
GO
RESTORE LOG CLIENTES FROM DISK='P:\BACKUP\CLIENTES_BK-LOG2.TRN' 
WITH RECOVERY, STATS
...
BACKUP DATABASE CLIENTES TO DISK= 'P:\BACKUP\CLIENTES_4_FULL.BAK' WITH STATS
GO 
...
BACKUP DATABASE CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-DFF1.DIF' WITH DIFFERENTIAL
...
BACKUP DATABASE CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-DFF2.DIF' WITH DIFFERENTIAL
...
BACKUP DATABASE CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-DFF3.DIF' WITH DIFFERENTIAL
...
RESTORE HEADERONLY FROM DISK = 'P:\BACKUP\CLIENTES_4_FULL.BAK'
RESTORE HEADERONLY FROM DISK = 'P:\BACKUP\CLIENTES_BK-DFF1.DIF'
RESTORE HEADERONLY FROM DISK = 'P:\BACKUP\CLIENTES_BK-DFF2.DIF'
RESTORE HEADERONLY FROM DISK = 'P:\BACKUP\CLIENTES_BK-DFF3.DIF'
...
BACKUP LOG CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-LOG_TAILLOG.TRN'
...
USE MASTER
GO
RESTORE DATABASE CLIENTES FROM DISK='P:\BACKUP\CLIENTES_4_FULL.BAK' 
WITH NORECOVERY,STATS
GO

-- RESTAURANDO 3º BACKUP DIFERENTIAL. Nao precisa retornar o DIF1 E DIF2 PORQUE O DIF3 TEM TUDO QUE TINHA NO 
-- DIF1 E DIF2
RESTORE DATABASE CLIENTES FROM DISK='P:\BACKUP\CLIENTES_BK-DFF3.DIF' 
 WITH  NORECOVERY,REPLACE, STATS

-- RESTAURANDO TAILLOG
RESTORE LOG CLIENTES FROM DISK = 'P:\BACKUP\CLIENTES_BK-LOG_TAILLOG.TRN'
WITH NORECOVERY, STATS
...
BACKUP DATABASE CLIENTES
TO 
DISK = 'P:\BACKUP\CLIENTES_MULTIPLOFIL1_FULL.BAK',
DISK = 'P:\BACKUP\CLIENTES_MULTIPLOFIL2_FULL.BAK',
DISK = 'P:\BACKUP\CLIENTES_MULTIPLOFIL3_FULL.BAK',
DISK = 'P:\BACKUP\CLIENTES_MULTIPLOFIL4_FULL.BAK'
WITH STATS

-- FAZENDO BACKUP DO LOG
BACKUP LOG CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-MULTIPLO_LOG1.TRN'
...
TO FILE = 'P:\BACKUP\CERTBACKUPSQL.cer' -- LOCAL ONDE SERA ARMAZENADO O CERTIFICADO
WITH PRIVATE KEY (
FILE = 'P:\BACKUP\CERTBACKUPSQL.key', -- LOCAL ONDE SERA ARMAZENADO A CHAVE PRIVADA DO CERTIFICADO
...
BACKUP DATABASE CLIENTES
TO DISK = N'P:\BACKUP\CLIENTES_CRIPTOGRAFADO.BAK' 
WITH COMPRESSION, 
...
GO
RESTORE DATABASE CLIENTES 
FROM DISK = N'P:\BACKUP\CLIENTES_CRIPTOGRAFADO.BAK' 
GO
...
BACKUP LOG CLIENTES TO DISK = 'P:\BACKUP\CLIENTES_BK-LOG_TAILLOG2.TRN'
WITH NO_TRUNCATE -- FUNDAMENTAL COLOCAR ESTA CLAUSULA 
GO
RESTORE DATABASE CLIENTES 
FROM DISK = N'P:\BACKUP\CLIENTES_CRIPTOGRAFADO.BAK' 
...
go
CREATE CERTIFICATE CERTBACKUPSQL
FROM FILE = N'P:\BACKUP\CERTBACKUPSQL.cer'
WITH PRIVATE KEY ( 
FILE = N'P:\BACKUP\CERTBACKUPSQL.key',
